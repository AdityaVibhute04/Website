...
document.getElementById('inputForm').addEventListener('submit', function(event) {
    ...
    let batteryCapacity = (epsilon - 1) * Eload;
    let initialInvestment = 54 * solarWattage + 29000 * batteryCapacity;
    let annualCashInflow = (peakRate * peakTimeDurationDay * peakLoad + normalRate * normalTimeDuration * normalLoad + peakRate * Eload * (epsilon - 1)) * 365;
